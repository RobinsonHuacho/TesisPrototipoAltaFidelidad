...
public class InformacionGeneralDonador extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_informacion_general_donador);
                ...
                myTTS=new TextToSpeech(this,  new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int status) {
                        if(myTTS.getEngines().size()==0){
                            Toast.makeText(InformacionGeneralDonador.this, "No se ha inicializado TextToSpeech en su dispositivo",Toast.LENGTH_LONG).show();
                            finish();
                        }else{
